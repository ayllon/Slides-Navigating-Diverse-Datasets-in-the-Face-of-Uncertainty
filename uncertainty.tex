...
\begin{frame}{Bottom-Up Search}
    ...
    \smallskip
    Generally, if we have an n-EDD between two datasets and traverse the lattice bottom-up,
    the number of possible combinations we need to test is:
...
\note{
Another option is a Top-Down search (optimistic): we assume $n$ 1-EDDs are derived from a single $n$-EDD.
